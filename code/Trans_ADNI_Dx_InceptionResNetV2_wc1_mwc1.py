...
#    del Data_Train_Shifted
    ...
    with tf.device('/cpu:0'):
        OldModel = load_model('./Classifier_Sex/20200427_Phase4_FromScratch_Gender_IncepResN_lr01_AllIn.h5')
        OldModel.layers.pop()
        OldModel.layers.pop()
        
        x = Dropout(0.5,name='dropout1')(OldModel.layers[-1].output)
...
#            print(layer.name + ' is set to trainable')
#        else:
#            layer.trainable = False
#            print(layer.name + ' is set to untrainable')
