...
function start(response) {
    ...
    var body = '<html style="background-color: antiquewhite">' +
        ...
        'line-height: 2;\n' +
        'letter-spacing: 1px;\n' +
        'font-family: Arial;">This is a website to demonstrate BrainImageNet: an Industrial-Grade Brain Imaging Based Deep Learning Classifier. We openly shared our trained model, code and framework (https://github.com/Chaogan-Yan/BrainImageNet), and here built an online predicting website for whoever are interested in testing our classifier with brain imaging data from anybody and any scanner. Please upload brain structural data (raw data or preprocessed gray matter density/volume data) to predict the sex of the participant(s). OF NOTE: FOR RESEARCH PURPOSE ONLY!\n</p>' +
        '<br>' +
